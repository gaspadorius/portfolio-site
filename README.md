...
"# portfolio-site"  git init git add README.md git commit -m "first commit" git remote add origin https://github.com/gaspadorius/portfolio-site.git git push -u origin master
"# portfolio-site" 
